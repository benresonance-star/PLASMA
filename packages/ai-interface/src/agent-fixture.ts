...
export function runScriptedAgentFixture(): AgentFixtureResult {
  ...
  const proposed: ChangeSet = {
    ...
    commands: [{ op: 'update', targetId: DEMO_Y_SEMANTIC_ID, payload: { lengthMm: 2400 } }],
    actor: 'ai',
  ...
  repair = runRepairAttempt({
    ...
    changeSet: {
      ...
      expectedHeadHash: head,
      commands: [{ op: 'update', targetId: DEMO_Y_SEMANTIC_ID, payload: { lengthMm: 2200 } }],
      disposition: 'proposed',
    },
    currentHeadHash: head,
    agentBranchId,
  ...
  repair = runRepairAttempt({
    ...
    changeSet: {
      ...
      expectedHeadHash: head,
      commands: [{ op: 'update', targetId: DEMO_Y_SEMANTIC_ID, payload: { lengthMm: 2000 } }],
      disposition: 'proposed',
    },
    currentHeadHash: head,
    agentBranchId,
